...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@prestashop.local";
    ...
    * @var string
    */
	protected $baseDn = "DC=WIN-1JGKJ5CAIPI,DC=prestashop.local"; 
    ...
    * @var array
    */
    protected $domainControllers = array("WIN-1JGKJ5CAIPI.prestashop.local");
